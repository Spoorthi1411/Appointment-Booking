    ...
    <div>
        <div className='flex items-center flex-col gap-3 justify-center'>
            <p className='font-bold text-[46px] text-center'>
               Find Home <span className='text-[#d86e7c]'>Services/Repair </span><br/> Near You 
            </p>
            <p className='text-xl text-gray-400 font-semibold text-sm'>Explore Best Home Services & Repair near me</p>
