...
const Footer = () => {
  return (
    <div className='md:mx-10'>
      <div className='flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm'>
        ...
        <div>
            <div className='mb-5 flex items-center'>
                ...
                <p className='text-[#d86e7c] font-bold text-2xl curso'>TaskBazaar</p>
            </div>
      ...
      <div>
        <hr />
        <p className='py-5 text-sm text-center'>Copyright 2025@ TaskBazaar - All Right Reserved</p>
      </div>
    </div>
  )
}
