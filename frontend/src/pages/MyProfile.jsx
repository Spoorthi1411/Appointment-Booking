    ...
    <div className='w-full flex gap-10 text-sm lg:flex-row'>
      ...
      <div className='w-2/3'>
        ...
        <div className='flex justify-between'>
          ...
          <div className='text-base w-1/2'>
            ...
            <div className='grid grid-cols-[2fr_4fr] gap-y-2.5 mt-3 text-neutral-700 mr-2'>
              ...
              {
              isEdit 
                ? <select className='max-w-25 bg-gray-100' onChange={(e)=>setUserData(prev => ({...prev,gender:e.target.value}))} value={userData.gender}>
              ...
              {
                isEdit 
                ? <input className='max-w-25 bg-gray-100' onChange={(e)=>setUserData(prev => ({...prev,dob:e.target.value}))} value={userData.dob} type='date'/>
        ...
        <div className='text-center'>
            {
              isEdit
              ? <button className='border-2 border-zinc-200 shadow-sm rounded-md bg-gray-500 text-white text-center mt-10 p-1' onClick={()=>setIsEdit(false)}>Save Information</button>
              : <button className='border-2 border-zinc-200 shadow-sm rounded-md bg-gray-500 text-white text-center mt-10 p-1' onClick={()=>setIsEdit(true)}>Edit</button>
            }
        </div>
      </div>
    </div>
